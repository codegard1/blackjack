...
// Local Resources
import './App.css';
import { IndexedDB, PlayerStore, PlayingCardDeck } from './src/classes';
import AppContext from './src/classes/AppContext';
import { ActivityLog, OptionsPanel, SplashScreen, Table } from './src/components';
import { defaultPlayers } from './src/definitions';
import { GameStatus } from './src/enums/GameStatus';
import { IAppContextProps, IGameStoreProps, ISettingStoreProps } from './src/interfaces';
import { MessageBarDefinition, PlayerKey, PlayerStats } from './src/types';
...
const App_old = () => {
  ...
  const [playerStore] = React.useState<PlayerStore>(new PlayerStore(defaultPlayers));
